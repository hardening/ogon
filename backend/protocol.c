...
static BOOL ogon_read_capabilities(wStream *s, ogon_msg_capabilities *msg) {
	...
	ogon__backend__capabilities__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_version(wStream *s, ogon_msg_version* msg) {
	...
	ogon__backend__version_reply__free_unpacked(proto, NULL);
	return ret;
}
...
static BOOL ogon_read_synchronize_keyboard_event(wStream *s, ogon_msg_synchronize_keyboard_event *msg) {
	...
	msg->clientId = proto->clientid;
	ogon__backend__keyboard_sync__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_scancode_keyboard_event(wStream *s, ogon_msg_scancode_keyboard_event *msg) {
	...
	msg->keyboardType = proto->keyboardtype;
	msg->clientId = proto->clientid;
	ogon__backend__keyboard_scan_code__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_unicode_keyboard_event(wStream *s, ogon_msg_unicode_keyboard_event *msg) {
	...
	msg->code = proto->code;
	msg->clientId = proto->clientid;
	ogon__backend__keyboard_unicode__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_mouse_event(wStream *s, ogon_msg_mouse_event *msg) {
	...
	msg->y = proto->y;
	msg->clientId = proto->clientid;
	ogon__backend__mouse_event__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_extended_mouse_event(wStream *s, ogon_msg_extended_mouse_event *msg) {
	...
	msg->y = proto->y;
	msg->clientId = proto->clientid;
	ogon__backend__mouse_extended_event__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_framebuffer_sync_request(wStream *s, ogon_msg_framebuffer_sync_request *msg) {
	...
	ogon__backend__sync_request__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_sbp_reply(wStream *s, ogon_msg_sbp_reply *msg) {
	...
	ret = TRUE;
out:
	ogon__backend__sbp_reply__free_unpacked(proto, NULL);
	return ret;
}
...
static BOOL ogon_read_seat_new(wStream *s, ogon_msg_seat_new* msg) {
	...
	msg->keyboardType = proto->keyboardtype;
	msg->keyboardSubType = proto->keyboardsubtype;
	ogon__backend__seat_new__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_seat_removed(wStream *s, ogon_msg_seat_removed* msg) {
	...
	msg->clientId = proto->clientid;
	ogon__backend__seat_removed__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_user_message(wStream *s, ogon_msg_message *msg) {
	...
	ret = TRUE;
out:
	ogon__backend__message__free_unpacked(proto, NULL);
	return ret;
}
...
out:
	if (!ret) {
		...
		msg->andMaskData = NULL;
		free(msg->xorMaskData);
		msg->xorMaskData = NULL;
	}
	ogon__backend__set_pointer_shape__free_unpacked(proto, NULL);
	return ret;
}
...
static BOOL ogon_read_set_system_pointer(wStream *s, ogon_msg_set_system_pointer* msg) {
	...
	msg->clientId = proto->clientid;
	ogon__backend__set_system_pointer__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_beep(wStream *s, ogon_msg_beep *msg) {
	...
	ogon__backend__beep__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_sbp_request(wStream *s, ogon_msg_sbp_request *msg) {
	...
	ret = TRUE;
out:
	ogon__backend__sbp_request__free_unpacked(proto, NULL);
	return ret;
}
...
static BOOL ogon_read_framebuffer_sync_reply(wStream *s, ogon_msg_framebuffer_sync_reply *msg) {
	...
	msg->bufferId = proto->bufferid;
	ogon__backend__sync_reply__free_unpacked(proto, NULL);
	return TRUE;
}
...
static BOOL ogon_read_message_reply(wStream *s, ogon_msg_message_reply *msg)
{
	...
	ogon__backend__message_reply__free_unpacked(proto, NULL);
	return TRUE;
}

...
#define PROPERTY_ITEM_INIT_BOOL(K, V) { .path = K, .propertyType = PROPERTY_BOOL, .success = FALSE, .v = { .boolValue = V } }
#define PROPERTY_ITEM_INIT_INT(K, V) { .path = K, .propertyType = PROPERTY_NUMBER, .success = FALSE, .v = { .intValue = V } }
